   ...
   <aside class="col-lg-3 col-md-12 car">
                    ...
                    <div class="col-lg-9 col-md-12 blog-pots" id="property">
                                ...
                                <div class="detail-wrapper-body">
                                    <div class="listing-title-bar">
                                        <div class="text-heading text-left">
                                            <p class="font-weight-bold mb-0 mt-3"><?= count($searchpage);?> Search results</p>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="row" >
                            <?php
                                if(count($searchpage)) {
                                    foreach ($searchpage as $key => $feature) {
                                        $id = $feature->id;
...
<script type="text/javascript">
    ...
    function filter_data()
    {
        ...
        var pcat = "<?= @$_POST['pcat'];?>";       
        var ptype = "<?= @$_POST['ptype'];?>";       
        $.ajax({
            url:"<?= base_url();?>home/getserachFilters",
            method:"POST",
             dataType :"json",
            data:{amenities:amenities,bhk:bhk,location:location,pcat:pcat,ptype:ptype,role:role,availablefrom:availablefrom,facing:facing,furnish:furnished,floors:floors,carpark:carpark, "<?= $this->security->get_csrf_token_name();?>": $(".csrf_token").val()},
