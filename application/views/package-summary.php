  ...
  <!-- START SECTION PAYMENT-METHOD -->
        <section class="payment-method notfound" style="padding:50px 0px">
            <div class="container">
                <img src="<?= asset_url();?>images/logo.png" style="width: 110px;margin-bottom: 20px" data-sticky-logo="images/logo.png"
                alt="" >
...
<script>
var options = {
    "key": "rzp_live_TFHJWLCUx9Y4od",
    "amount": "<?php echo array_sum($price)*100;?>", 
    "currency": "INR",
