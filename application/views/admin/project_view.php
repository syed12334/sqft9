<?php  //echo "<pre>";print_r($areaname);exit; //count($propertyPackcount);exit; //echo $userPackage[0]->properties;exit;  ?>
<?= $header;?>
<style type="text/css">
                ...
                <div class="row">
                    <div class="col-lg-8 col-md-12 blog-pots">
                       ...
                       <?php
                            ...
                            <?php
                                $getamenities = $this->master_db->sqlExecute('select pa.p_amenities,a.title from property_amenities pa left join amenities a on a.id = pa.p_amenities left join properties p on p.id = pa.prid where p.id='.$property[0]->id.' group by p_amenities ');
//echo $this->db->last_query();
                        ...
                        <?php
                             ...
                             if(is_array($userPackage) && count($userPackage) >0) {
                                    $ar = [];
                                    if(count($userPackage) >0) {
                                     ...
                                     if(count($propertyPackcount)  >=  array_sum($ar)) {
                            ...
                            <h5>Location</h5>
                            <?php   if(!empty($property[0]->embedmap)) {
                                        echo $property[0]->embedmap;
                                    }?>
                        </div>
                                        <?php
                                     }
                                    ...
                                    if(count($userPackage) >0) {
                                        foreach ($userPackage as $key => $value) {
                                          $ar[] = $value->properties;
                                               ...
                                               if(count($propertyPackcount)  >=  array_sum($ar)) {
                                      echo "<p style='color:red'>Your package limit exceeded please renew now</p>"; 
                                      ?>
<a href="<?= base_url().'property/addpackages';?>" class="btn btn-danger" style="background-color: #c82333!important">PAY NOW</a>                                      <?php
                                    }else {
                                        ?>
                                    ...
                                    <div class="widget-boxed-body">
                                        <div class="sidebar-widget author-widget2">
                                            <div class="author-box clearfix">
                                                <img src="<?= asset_url();?>images/testimonials/ts-1.jpg" alt="author-image" class="author__img" style="width:40px!important;height: auto!important">
                                  ...
                                  <?php 
                                                        if(!empty($property[0]->ophone)) {
                                                           ?>
                                                                            <li><span class="la la-phone"><i class="fa fa-phone" aria-hidden="true"></i></span><a href="tel:<?php echo $property[0]->ophone;?>"><?php echo $property[0]->ophone;?></a></li>
                                                           <?php
                                                        }
                                                    ?>
                                                   ...
                                                   <?php 
                                                        if(!empty($property[0]->oemail)) {
                                                           ?>
                                                                            <li><a href="mailto:<?php echo $property[0]->oemail;?>"><span class="la la-envelope-o"><i class="fa fa-envelope"></i> <?php echo $property[0]->oemail;?></span></a></li>
                                                           <?php
                                                        }
                                                    ?>
                                ...
                                <div class="main-search-field-2">
                                    <div class="widget-boxed mt-5">
                                        ...
                                        <div class="widget-boxed-body inner-pages">
                            ...
                            <?php
                                ...
                                <div class="project-single">
                                    ...
                                    <div class="homes-content">
                                        <!-- homes address -->
                                        <h3><a href="<?= base_url().$sim->slug;?>"><?= ucfirst($sim->title);?></a></h3>
