...
<!-- Mirrored from code-theme.com/html/findhouses/invoice.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 31 May 2022 08:27:41 GMT -->
<head>
    <meta charset="UTF-8">
        ...
        <section class="user-page section-padding">
            <div class="container-fluid">
                <div class="row">
                        ...
                        <div class="user-profile-box mb-0">
                            ...
                            <div class="detail clearfix">
                                <ul class="mb-0">
                                    ...
                                    <li>
                                        <a class="active" href="my-subscription.html">
                    ...
                    <div class="col-lg-9 col-md-12 col-xs-12 py-0 pl-0 user-dash2 pt-5">
                            ...
                            <div class="property-form-group">
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="card">
                                            <div class="card-body renew-t"> <h3>Rental Subscription - $999  </h3> <span class="text-danger ml-2 mr-5">2 days left</span> <button class="btn btn-dark">Renew</button></div>
                                        </div>
