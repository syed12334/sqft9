        ...
        <div class="row">
            <div class="col-md-12">
                    ...
                    <div class="card-body">
                        ...
                        <div class="card-title">Customer Reports</div>
                          <?php 
...
<script type="text/javascript">
    var dataTable, edit_data;
            function initialiseData(){
                ...
                dataTable = $('#category_table').DataTable({  
                    ...
                    "order":[],  
                    "ajax":{  
                        url:"<?=base_url().'reports/getCustomersreports'?>",  
                        type:"POST",
                        data: function(d){
  ...
  function exportexcel(){
               ...
               document.location.href =base_url+"reports/exportcustomerreport?fdate="+fdate+"&tdate="+tdate;
          }
</script>