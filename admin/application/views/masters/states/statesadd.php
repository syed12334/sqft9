  ...
  <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
                           <div class="form-group">
                            <label>State Name <span style="color:red">*</span></label>
                               <input type="text" name="title" id="title" class="form-control" placeholder="Enter State Name" value="<?= $property[0]->name?>">
...
<input type="hidden" class="csrf_token" name="<?= $this->security->get_csrf_token_name();?>" value="<?= $this->security->get_csrf_hash();?>">
                           ...
                           <div class="form-group">
                            <label>State Name<span style="color:red">*</span></label>
                               <input type="text" name="title" id="title" class="form-control" placeholder="Enter State Name" >
                           </div>
