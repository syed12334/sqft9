        ...
        <div class="row">
            <div class="col-md-12">
                    ...
                    <div class="card-body">
                        ...
                        ?>
                        <a class="btn btn-success" href="<?= base_url().'partnersadd';?>" style="float: right;margin-bottom: 20px;margin-right: 20px"><i class="fa fa-plus"></i> Add</a>
                        <br /><br /><br />
...
<script type="text/javascript">
    ...
    function initialiseData(){
        ...
        dataTable = $('#category_table').DataTable( {
            ...
            "searching": true, 
            "ajax":{  
                  url:"<?=base_url().'master/getPartners'?>",  
                  type:"POST",
                  data: function(d){
                      d.forPost    = 1;
        ...
        initialiseData();
                ...
                function updateStatus(id,status){
                       var postdata = { id : id,status : status,"<?= $this->security->get_csrf_token_name();?>": $(".csrf_token").val() } ;
                        ...
                        $.ajax({                        
                            url: "<?=base_url().'master/setpartnersStatus'?>",
                            type: "post",
                            data:  postdata ,
                            dataType : 'json',
